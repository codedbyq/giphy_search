...
/*!**********************************!*\
  !*** ./actions/giphy_actions.js ***!
  \**********************************/
/*! exports provided: RECEIVE_SEARCH_GIPHYS, searchGiphy */
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "searchGiphy", function() { return searchGiphy; });
...
var searchGiphy = function searchGiphy(searchTerm) {
  return function (dispatch) {
    return _util_api_util__WEBPACK_IMPORTED_MODULE_0__["fetchSearchGiphys"](searchTerm).then(function (res) {
      return dispatch(receiveSearchGiphys(res));
    });
  };
};
...
/* harmony import */ var _dev_keys__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./dev_keys */ "./util/dev_keys.js");

var fetchSearchGiphys = function fetchSearchGiphys(searchTerm) {
  return $.ajax({
    method: 'get',
    url: "http://api.giphy.com/v1/gifs/search?q=".concat(searchTerm, "&api_key=").concat(_dev_keys__WEBPACK_IMPORTED_MODULE_0__["default"], "&limit=2")
  });
};
...
"use strict";
__webpack_require__.r(__webpack_exports__);
var DEV_KEY = 'L71a8OGkUIh5R6at9kvVMuY3nminlELP';
/* harmony default export */ __webpack_exports__["default"] = (DEV_KEY);
